...
// https://github.com/dudleystorey/CSSslidy/blob/gh-pages/cssslidy.js
...
var cssSlidy = function(newOptions) {
    var options = (function() {
        ...
        defaultOptions = {
            ...
            captionBackground: 'rgba(0,0,0,0.1)',
            captionColor: '#666',
            captionFont: 'Source Sans Pro, sans-serif',
            captionPosition: 'bottom', // options: top, bottom
            captionAppear: 'perm', //  options: slide, perm, fade
            captionSize: '1rem', // same units
            captionPadding: '.2rem' // same units
        };
    ...
    CS.init = (function() {
        ...
        if (options.captionSource == "alt" || options.captionSource == "data-caption") {
            css.innerHTML += options.slidySelector + " figure figcaption { position: absolute; width: 40%; background-color: " + options.captionBackground + "; color: " + options.captionColor + "; font-family: " + options.captionFont + ";";
